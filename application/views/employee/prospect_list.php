			...
			<div class="row justify-content-lg-center">
				<section class="col-lg-12 mb-2">
					<button
						...
						id="delete-registered-attended"
						data-confirm="Are you sure you want to delete all registered and attended status? This action cannot be undone."
					>
						Delete registered and attended status
					</button>
				</section>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade" id="payment-history" role="tabpanel">
									...
									<div class="tab-content" id="pills-tabContent">
										...
										>
											<table
												id="payment-history-table-walkin"
												class="table table-bordered table-hover"
											>
												<thead>
													<tr>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="input-group mb-3">
						<input
							type="text"
							class="form-control <?= form_error('user-dob') ? 'is-invalid' : '' ?>"
							placeholder="Date paid"
							name="user-dob"
							data-inputmask-alias="datetime"
							data-inputmask-inputformat="mm/dd/yyyy"
							data-mask
							value="<?= set_value('user-dob') ?>"
						/>
						<div class="input-group-append">
							<div class="input-group-text">
